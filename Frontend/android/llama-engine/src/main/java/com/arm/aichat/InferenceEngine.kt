...
interface InferenceEngine {
     ...
     *
     * @throws ModelLoadException if native model loading fails
     */
...
class ModelLoadException(message: String? = null) : Exception(message)
class UnsupportedArchitectureException(message: String? = null) : Exception(message)
